"""
Django settings for rim_backend project.
...
SECRET_KEY = 'django-insecure-+qjl2t*c_@9mj2tqycfy32x%lq43^^_%*o^!v=79w)!$z@&vg3'
...
WSGI_APPLICATION = 'rim_backend.wsgi.application'
